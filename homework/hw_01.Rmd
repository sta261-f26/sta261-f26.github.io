...
* Download the [HW 1 template](https://sta261-f26.github.io/homework/hw_01_template.qmd), and open the template (a Quarto document) in RStudio. 
...
For the remainder of the course, we will submit assignments through GitHub instead of on Canvas. Follow the [Git and GitHub setup instructions](https://sta261-f26.github.io/resources/github_instructions/) on the course website and submit the *Example Assignment* on GitHub. Completing this example assignment will count towards your HW 1 grade.
