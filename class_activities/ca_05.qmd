...
* To get started, download the [class activity template](https://sta261-f26.github.io/class_activities/ca_05_template.qmd) file
...
cleaned_data <- read_csv("https://sta261-f26.github.io/class_activities/cleaned_dog_data.csv")
```
