...
* To get started, download the [class activity template](https://sta261-f26.github.io/class_activities/ca_04_template.qmd) file
...
*Hint:* In `pivot_longer`, using `cols = -col1` will pivot all columns except `col1`. If you want to pivot all columns except `col1` and `col2`, then you would use
